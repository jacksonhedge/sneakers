...
export const VENUES: Venue[] = [
  ...
  },
  {
    ...
    category: 'prediction_market',
    status: 'coming_soon',
    blurb: 'BNB Chain CLOB prediction market. Macro + crypto-heavy, third-largest by volume.',
    affiliateUrl: 'https://opinion.trade',
  },
  {
    id: 'dk_predictions',
  ...
  },
  {
    ...
    category: 'sportsbook',
    status: 'live',
    blurb: 'Major US sportsbook operator. Odds sourced via The Odds API.',
  },
  {
    id: 'caesars',
    ...
    category: 'sportsbook',
    status: 'live',
    blurb: 'Caesars Entertainment’s sportsbook. Odds sourced via The Odds API (legacy William Hill US key).',
  },
  {
    id: 'espn_bet',
    name: 'theScore Bet',
  ...
  },
  {
    ...
    category: 'sportsbook',
    status: 'live',
    blurb: 'Rush Street Interactive sportsbook. Odds sourced via The Odds API.',
  },
  {
    id: 'pointsbet_us',
    name: 'PointsBet',
    category: 'sportsbook',
    status: 'live',
    blurb: 'US sportsbook (now Fanatics-owned brand). Odds sourced via The Odds API.',
  },
  {
    id: 'hard_rock_bet',
    name: 'Hard Rock Bet',
