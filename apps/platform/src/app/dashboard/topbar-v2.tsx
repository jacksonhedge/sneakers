  ...
  return (
    <header className="border-b border-stone-200 bg-white sticky top-0 z-30">
      <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2.5">
        {/* Brand + identity */}
        <Link href="/dashboard/legacy" prefetch={false} className="flex items-center gap-2.5 shrink-0 pr-2">
          ...
          <span className="text-sm text-stone-900 font-medium truncate max-w-[90px] sm:max-w-[140px] md:max-w-[200px]">
            {headerName}
          </span>
        </Link>
...
// blue/gold/navy accents. Hidden on mobile (handled inline via Tailwind).
