...
export default async function AffiliatesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <div className="text-xs text-[#1E3A8A] tracking-wider mb-1">{'>'} VENUE AFFILIATE LINKS</div>
        ...
        <p className="text-sm text-stone-500 mt-1 max-w-2xl">
          ...
          <Link href="/audit" className="text-[#1B4DE4] underline">audit log</Link> with the prior values + actor.
